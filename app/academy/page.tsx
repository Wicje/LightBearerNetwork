    ...
    <main className="min-h-screen bg-[#363535] text-white selection:bg-[#F2994A] selection:text-white pb-32">
      ...
      <section className="pt-40 md:pt-48 pb-20 px-6">
        ...
        >
          ...
          <button className="bg-[#107C41] hover:bg-[#0c5c30] text-white px-8 py-4 rounded-[4px] font-mono font-bold tracking-[0.1em] transition-all uppercase text-[12px] flex items-center gap-2 justify-center w-full sm:w-auto hover:scale-105 active:scale-95">
      ...
      <section className="py-20 md:py-32 px-6 text-center">
        ...
        <button className="bg-[#F2994A] hover:bg-[#df8b40] text-white px-8 py-5 md:px-10 rounded-[4px] font-mono font-bold tracking-[0.1em] transition-colors uppercase text-[12px] md:text-[14px] w-full sm:w-auto">
          Access Academy
        </button>
      </section>
    </main>
